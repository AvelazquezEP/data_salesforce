...
$p_total_daily = [44.92, -40.63, -53.52, 8.47, 25.43, 1.72];
$p_paid_search = [50.18, -84.49, -91.07, -1.27, 20.47, 120];
$p_direct = [21.05, 66.15, 69.64, 87.5, 45.45, -27.59];
$p_organic_search = [48, -58.33, -66.67, -11.54, 20, -29.41];
$p_organic_social = [-33.33, -100, -100, -50, 0, 50];
$p_referral = [0, 0, -100, 0, -50, 0];
/* #endregion */
