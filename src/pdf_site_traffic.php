...
$p_total_daily = [-50.45, -53.14, -51.7];
$p_paid_search = [-79.74, -82.21, -90.32];
$p_direct = [3.28, -5.8, 160.53];
$p_organic_search = [-55.88, -22.22, -33.33];
$p_organic_social = [-50, -71.43, -80];
$p_referral = [0, -50, -33.33];
/* #endregion */
