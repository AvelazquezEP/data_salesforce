...
/* #region 09 January - 15 January */
$p_total_daily = [-63.96, -52.1, 35.34, 42.03, -36.07, -62.1];
$p_paid_search = [-83.57, -88.02, 66.67, 92.11, -37.6, -88.42];
$p_direct = [-37.65, 55.56, -4.44, -5.56, -48.08, 22.22];
$p_organic_search = [-60, -46.43, 100, -27.27, 50, -45.45];
$p_organic_social = [-100, 100, 25, -100, -50, 0];
$p_referral = [-100, 0, -100, 0, 0, 0];
/* #endregion */
