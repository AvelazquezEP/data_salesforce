...
$p_total_daily = [-68.49, -49.8, -24.26];
$p_paid_search = [-86.19, -75.16, -66.98];
$p_direct = [-59.09, -45.31, -26.83];
$p_organic_search = [-79.17, -39.13, -58.82];
$p_organic_social = [-100, -60, -25];
$p_referral = [-50, -100, -100];
/* #endregion */
