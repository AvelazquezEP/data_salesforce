...
$p_total_daily = [-35.68, -45.33, -65.56, 22.78, 3.82, -15.79];
$p_paid_search = [-66.05, -81.05, -90.61, 33.33, 37.1, -45.45];
$p_direct = [6.67, -12.77, -46.97, -6.9, 37.1, 42.86];
$p_organic_search = [-50, -23.53, -33.33, 25, -30.77, -71.43];
$p_organic_social = [-33.33, -100, 0, -80, 0, -50];
